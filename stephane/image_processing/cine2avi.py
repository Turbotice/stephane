...
def gen_parser():    
    ...
    parser.add_argument('-range', metavar='range', type=str, nargs='+', help='input cine file(s), append [start:end:skip] (python slice notation) to filename to convert only a section')
